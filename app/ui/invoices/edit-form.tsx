...
import { EditState, updateInvoice } from "@/app/lib/actions";
...
export default function EditInvoiceForm({
	...
	const initialState: EditState = { message: null, errors: {}, formData:{
    id: invoice.id,
  ...
  console.log(state)
	return (
		<form action={formAction}>
          ...
          <div id="form-error" aria-live="off" aria-atomic="false">
						{state.message && (
